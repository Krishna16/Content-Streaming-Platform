...
public class YoutubeAPI {
    ...
    public String getYoutubeVideoId(String movie_title) throws GeneralSecurityException, IOException {
        YouTube youtubeService = getService();
        // Define and execute the API request
        YouTube.Search.List request = youtubeService.search()
                .list("snippet");
        SearchListResponse response = request.setMaxResults(1L)
                .setQ(movie_title + " Trailer")
                .execute();
        //System.out.println(response);
        Log.d("Youtube API: ", "Video ID: " + response);
